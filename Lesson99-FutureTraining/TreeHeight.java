/**
 * Task description In this problem we consider binary trees, represented by
 ...
 * or right subtree of P[I], for 0 ≤ I < K. For example, the sequence of nodes
 ...
 * from the above figure can be denoted as:
 * 
 ...
 * Assume that:
 * 
 * N is an integer within the range [1..1,000]; the height of tree T (number of
 * edges on the longest path from root to leaf) is within the range [0..500].
 * Complexity:
 * 
